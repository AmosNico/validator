...
@[expose]
public def constraintUD (Kᵢ S1ᵢ K1ᵢ K2ᵢ : ℕ) :=
...
-/
@[expose]
public def constraintSD (Kᵢ Sᵢ K1ᵢ K2ᵢ : ℕ) :=
  stateBounds' C Sᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintPG (Kᵢ Sᵢ K1ᵢ K2ᵢ K3ᵢ : ℕ) :=
  stateBounds' C Sᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintPI (Kᵢ S1ᵢ K1ᵢ K2ᵢ K3ᵢ : ℕ) :=
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K3ᵢ ∧ᶜ
...
@[expose]
public def constraintRG (Kᵢ S1ᵢ K1ᵢ K2ᵢ K3ᵢ : ℕ) :=
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K3ᵢ ∧ᶜ
  ((isStateNeg C S1ᵢ).seq fun Sᵢ ↦
...
@[expose]
public def constraintRI (Kᵢ Sᵢ K1ᵢ K2ᵢ K3ᵢ : ℕ) :=
  stateBounds' C Sᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K3ᵢ ∧ᶜ
...
@[expose]
public def constraintUR (T : SetType) (Eᵢ E1ᵢ : ℕ) :=
  setBounds' C T Eᵢ ∧ᶜ
  (isUnion C T E1ᵢ).leftEq T Eᵢ

@[expose]
public def constraintUL (T : SetType) (Eᵢ E1ᵢ : ℕ) :=
  setBounds' C T Eᵢ ∧ᶜ
  (isUnion C T E1ᵢ).rightEq T Eᵢ

@[expose]
public def constraintIR (S1ᵢ Sᵢ : ℕ) :=
  stateBounds' C Sᵢ ∧ᶜ
  (isStateInter C S1ᵢ).leftEqState Sᵢ

@[expose]
public def constraintIL (S1ᵢ Sᵢ : ℕ) :=
  stateBounds' C Sᵢ ∧ᶜ
  (isStateInter C S1ᵢ).rightEqState Sᵢ

@[expose]
public def constraintDI (S1ᵢ S2ᵢ : ℕ) :=
...
@[expose]
public def constraintSU (T : SetType) (Kᵢ E1ᵢ E''ᵢ K1ᵢ K2ᵢ : ℕ) :=
  setBounds' C T E''ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintSI (Kᵢ Sᵢ S1ᵢ K1ᵢ K2ᵢ : ℕ) :=
  stateBounds' C Sᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintST (T : SetType) (Kᵢ Eᵢ E''ᵢ K1ᵢ K2ᵢ : ℕ) :=
  setBounds' C T Eᵢ ∧ᶜ
  setBounds' C T E''ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintAT (Kᵢ S1ᵢ S'ᵢ K1ᵢ K2ᵢ : ℕ) :=
  stateBounds' C S'ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintAU (Kᵢ S1ᵢ S'ᵢ K1ᵢ K2ᵢ : ℕ) :=
  stateBounds' C S'ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintPT (Kᵢ S1ᵢ S''ᵢ K1ᵢ K2ᵢ : ℕ) :=
  stateBounds' C S''ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintPU (Kᵢ S1ᵢ S''ᵢ K1ᵢ K2ᵢ : ℕ) :=
  stateBounds' C S''ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K2ᵢ ∧ᶜ
...
@[expose]
public def constraintPR (Kᵢ S1ᵢ S2ᵢ K1ᵢ : ℕ) :=
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
...
@[expose]
public def constraintRP (Kᵢ S1ᵢ S'ᵢ K1ᵢ : ℕ) :=
  stateBounds' C S'ᵢ ∧ᶜ
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
...
@[expose]
public def constraintCI (Kᵢ K1ᵢ : ℕ) :=
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  (isDeadKnowledge C K1ᵢ).seq fun SIᵢ ↦
    isStateInit C SIᵢ

@[expose]
public def constraintCG (Kᵢ K1ᵢ : ℕ) :=
  knowledgeBounds Kᵢ K1ᵢ ∧ᶜ
  (isDeadKnowledge C K1ᵢ).seq fun SGᵢ ↦
    isStateGoal C SGᵢ

@[expose]
public def constraintKnowledge {C : Certificate pt} (hC : C.validSets) (Kᵢ : Fin C.knowledge.size) :
    Σ α, Constraint α :=
...
@[expose]
public def validKnowledge {C : Certificate pt}
...
public lemma actionUnionBounds {C : Certificate pt} (hC : C.valid) (Aᵢ : Fin C.actions.size)
...
public lemma stateUnionBounds {C : Certificate pt} (hC : C.valid) (Sᵢ : Fin C.states.size)
...
public lemma stateInterBounds {C : Certificate pt} (hC : C.valid) (Sᵢ : Fin C.states.size)
...
public lemma stateProgrBounds {C : Certificate pt} (hC : C.valid) (Sᵢ : Fin C.states.size)
...
public lemma deadKnowledgeBound {C : Certificate pt} (hC : C.valid) (Kᵢ : Fin C.knowledge.size)
...
public lemma actionSubsetKnowledgeBounds
  ...
  simp only at h'
  cases K with
  | B5 => simp [Constraint.valid, constraintB5.prop_eq] at h'; tauto
...
public lemma stateSubsetKnowledgeBounds
    {C : Certificate pt} (hC : C.valid) (Kᵢ : Fin C.knowledge.size)
  ...
  simp only at h'
  cases K with
  | B1 => simp only [Constraint.valid, constraintB1.prop_eq] at h'; tauto
  | B2 => simp only [Constraint.valid, constraintB2.prop_eq] at h'; tauto
  | B3 => simp only [Constraint.valid, constraintB3.prop_eq] at h'; tauto
  | B4 => simp only [Constraint.valid, constraintB4.prop_eq] at h'; tauto
